...
que mostrará todos os clientes que realizaram pedidos. Acessando 
um dos clientes, você tem acesso às canecas que foram solicitadas na página de pedidos. Clicando sob a caneca escolhida, terá acesso às 
