                        ...
                        <div class="header-body">
                            <div class="row align-items-center py-4">
                                ...
                                <div class="col-lg-6 col-5 text-right">
                                    <a href="#" class="btn btn-light" id="btn-novo-cliente" data-toggle="modal" data-title="Cadastrar" data-target="#edit-modal"> <i class="fas fa-user-plus"></i> &nbsp;Novo Admin</a>
                                </div>
                            </div>
                        </div>
                    </div>
								 ...
								 box-shadow: 0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1);">
                                    ...
                                    <tbody>
                                        <c:forEach items="${accounts}" var="account">
                                            <tr>
                                                <td data-label="Nome" class="text-center">
													${account.username}
												</td>
												...
												data-pass="${account.password}" style="
												box-shadow: 0 0.5rem 1rem 0 rgba(0, 0, 0, 0.1);">
  ...
  <div class="modal-dialog modal-dialog-centered" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
       	Você tem certeza que deseja remover este Admin?
      </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <input name="username" type="text" class="form-control" id="username" required maxlength="255" />
                                        </div>
                                        <div class="form-group">
...
<script src="https://cdnjs.cloudflare.com/ajax/libs/malihu-custom-scrollbar-plugin/3.1.5/jquery.mCustomScrollbar.concat.min.js"></script>
	...
	<script src="src/js/ajax/edit.save.account.js"></script>
